...
<div class="container">
	...
	?>
		...
		$sql = "SELECT empresa.id, empresa.nombre, empresa.cif, empresa.descripcion, empresa.web, usuario.correo AS responsable "
		...
		if ($resultado) {
			...
			while ($empresa = mysqli_fetch_assoc($resultado)) {
			    ...
			    echo '<td>';
			    echo '<a class="btn btn-warning botonGestionEmpresa" href="modificarEmpresa.php?id=' . $empresa['id'] . '">Modificar</a>';
			    echo '<a class="btn btn-danger botonGestionEmpresa" href="javascript:bajaEmpresa(' . $empresa['id'] . ')">Dar de baja</a>';
			    echo '</td>';
			    echo '</tr>';
			}
		    } else {
